...
- Default to GPT-6 Sol for implementation, GPT-6 Luna for clear bounded tasks, Spark when available for tiny mechanical edits, and GPT-6 Astra for architecture, complex debugging, or an explicit user request. Follow the user's explicit model choice.
